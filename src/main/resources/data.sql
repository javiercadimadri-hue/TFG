...
INSERT IGNORE INTO Usuarios (id_usuario, nombre, email, contrasena, telefono, fecha_alta, rol, foto_filename, plan, fecha_expiracion_plan) VALUES
(1, 'Administrador', 'admin@test.com', 'admin123', '600123456', NOW(), 'ADMIN_ROLE', NULL, 'Premium VIP', DATE_ADD(NOW(), INTERVAL 30 DAY)),

-- Insertar usuario admin para testing (usando INSERT IGNORE para evitar duplicados)
INSERT IGNORE INTO Usuarios (id_usuario, nombre, email, contrasena, telefono, fecha_alta, rol, foto_filename) VALUES
(1, 'Administrador', 'admin@test.com', 'admin123', '600123456', NOW(), 'ADMIN_ROLE', NULL);

-- Insertar segundo usuario admin
INSERT IGNORE INTO Usuarios (id_usuario, nombre, email, contrasena, telefono, fecha_alta, rol, foto_filename) VALUES
(2, 'Super Administrador', 'superadmin@test.com', 'superadmin123', '600123457', NOW(), 'ADMIN_ROLE', NULL);

-- Insertar usuarios clientes de prueba
INSERT IGNORE INTO Usuarios (id_usuario, nombre, email, contrasena, telefono, fecha_alta, rol, foto_filename) VALUES
(3, 'Juan Pérez', 'juan@example.com', 'password123', '611111111', NOW(), 'USER_ROLE', NULL),
(4, 'María García', 'maria@example.com', 'password123', '622222222', NOW(), 'USER_ROLE', NULL),
(5, 'Carlos López', 'carlos@example.com', 'password123', '633333333', NOW(), 'USER_ROLE', NULL),
(6, 'Ana Martínez', 'ana@example.com', 'password123', '644444444', NOW(), 'USER_ROLE', NULL),
(7, 'Roberto Sánchez', 'roberto@example.com', 'password123', '655555555', NOW(), 'USER_ROLE', NULL),
(8, 'Tercer Admin', 'admin3@test.com', 'admin123', '600123458', NOW(), 'ADMIN_ROLE', NULL);
